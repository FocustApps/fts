...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "multi_email_flag", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "multi_attachment_flag", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("test_name", sa.String(), nullable=True),
        sa.Column(
            "requires_processing", sa.Boolean(), nullable=False, server_default="false"
        ),
