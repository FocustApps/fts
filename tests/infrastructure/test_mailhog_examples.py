...
class TestMailHogIntegration:
    ...
    def test_send_token_notification_email(self, mailhog: MailHogTestHelper):
        """Test sending token notification email."""
        test_token = "abc123def456token789012345678901234567890123456789012345678901234"
        ...
        # Assert email received and extract token
        message, extracted_token = mailhog.assert_token_email_sent(
            to_email="newuser@test.com", timeout=5
        )
        ...
        body = mailhog.get_email_body(message)
        assert "Welcome to the Fenrir Testing System, Test User!" in body
